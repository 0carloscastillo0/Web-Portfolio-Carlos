...
export const fallbackProjects: Project[] = [
  {
    ...
    skills: [
      ...
      { id: "2", name: "JavaScript", category: "Language", icon: "javascript", level: "Advanced" },
      { id: "3", name: "CSS3", category: "Frontend", icon: "css", level: "Advanced" },
      { id: "4", name: "HTML5", category: "Frontend", icon: "html5", level: "Advanced" },
      ...
      { id: "13", name: "Trello", category: "Project Management", icon: "trello", level: "Intermediate" },
      { id: "14", name: "Figma", category: "Design", icon: "figma", level: "Intermediate" },
    ]
  },
  {
    id: "2",
    ...
    skills: [
      { id: "1", name: "JavaScript", category: "Language", icon: "javascript", level: "Advanced" },
      { id: "2", name: "Python", category: "Language", icon: "python", level: "Intermediate" },
      { id: "3", name: "HTML5", category: "Frontend", icon: "html5", level: "Advanced" },
      { id: "4", name: "CSS3", category: "Frontend", icon: "css", level: "Advanced" },
  ...
  },
  {
    ...
    skills: [
      { id: "1", name: "HTML5", category: "Frontend", icon: "html5", level: "Advanced" },
      { id: "2", name: "Vue.js", category: "Frontend", icon: "vue", level: "Intermediate" },
      { id: "3", name: "BootStrap", category: "Frontend", icon: "bootstrap", level: "Intermediate" },
      { id: "4", name: "Spring Boot", category: "Backend", icon: "springboot", level: "Basic" },
      { id: "5", name: "PostgreSQL", category: "Databases", icon: "postgresql", level: "Advanced" },
      { id: "6", name: "Git", category: "Devops/Tools", icon: "git", level: "Advanced" },
      { id: "7", name: "GitHub", category: "Devops/Tools", icon: "github", level: "Advanced" },
      { id: "8", name: "Linux", category: "Devops/Tools", icon: "linux", level: "Intermediate" },
      { id: "9", name: "Docker", category: "Devops/Tools", icon: "docker", level: "Basic" },
      { id: "10", name: "Jira", category: "Project Management", icon: "jira", level: "Basic" },
      { id: "11", name: "Figma", category: "Design", icon: "figma", level: "Intermediate" },
    ]
  },
]